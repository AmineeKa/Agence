...
public class ArchivedClientList extends JFrame {
    ...
    private JButton restoreBtn, refreshBtn, closeBtn;
    ...
    public ArchivedClientList() {
        ...
        restoreBtn = new JButton("Restaurer");
        ...
        restoreBtn.addActionListener(e -> {
            ...
            if (id != null) setArchived(id, false);
        });
    ...
    private void updateButtons() {
        ...
        restoreBtn.setEnabled(hasSel); // Only action here
    }
    ...
    public void refresh() {
        ...
        StringBuilder sb = new StringBuilder(
                "SELECT ID, NOM, PRENOM, EMAIL, TELEPHONE, ISDELETED " +
                        "FROM CLIENT WHERE ISDELETED=TRUE ");
        if (!kw.isEmpty()) {
